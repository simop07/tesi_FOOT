...
\begin{document}
	...
	\subsection{Metodo del minimo $\chi^2$}
	...
	\begin{equation}
		\chi^2=\frac{\left(TOF-\overline{TOF}\right)^2}{\sigma^2_{TOF}}+\frac{\left(p-\overline{p}\right)^2}{\sigma^2_{p}}+\frac{\left(E_k-\overline{E_k}\right)^2}{\sigma^2_{E_k}}+\transp{\vect{A}}\matr{B}\vect{A}
		\label{eq:chi_square}
	\end{equation}
	...
	\begin{equation}
		\mathcal{L}_{ALM}\left(\vect{x};\vect{\lambda},\mu\right)=\mathcal{L}\left(\vect{x};\vect{\lambda}\right)+\frac{1}{2\mu}\sum_{i=1}^{m}c_i^2\left(\vect{x}\right)=f\left(\vect{x}\right)+\sum_{i=1}^{m}\lambda_ic_i\left(\vect{x}\right)+\frac{1}{2\mu}\sum_{i=1}^{m}c_i^2\left(\vect{x}\right)
	...
	\begin{equation}
		f\left(T,P,K\right)=\frac{\left(TOF-\overline{TOF}\right)^2}{\sigma^2_{TOF}}+\frac{\left(p-\overline{p}\right)^2}{\sigma^2_{p}}+\frac{\left(E_k-\overline{E_k}\right)^2}{\sigma^2_{E_k}}
	...
	\begin{equation}
		\begin{aligned}
			\mathcal{L}_{ALM}\left(T,P,K,A;\vect{\lambda},\mu\right)&=\frac{\left(TOF-\overline{TOF}\right)^2}{\sigma^2_{TOF}}+\frac{\left(p-\overline{p}\right)^2}{\sigma^2_{p}}+\frac{\left(E_k-\overline{E_k}\right)^2}{\sigma^2_{E_k}}+\\
