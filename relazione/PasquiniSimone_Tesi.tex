...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.7\linewidth]{momentum_deflession.pdf}
	...
	\end{figure}
	L'ES è composta da tre sezioni, la cui struttura è schematizzata in \hyperref[fig:structure_es]{Fig. 2.7}:
	\begin{itemize}
