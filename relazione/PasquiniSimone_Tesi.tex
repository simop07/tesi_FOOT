...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\subfloat[Distribuzione di $z$ determinata a partire dalla \hyperref[eq:atomic_number]{Eq. 3.2}]{\label{fig:atomic_numbersa}\includegraphics[width=.49\linewidth]{}}\hfill
		\subfloat[Distribuzione di $\Delta E_{TW}$ in funzione del TOF ]{\label{fig:atomic_numbersb}\includegraphics[width=.49\linewidth]{}}
	...
	La ridondanza del setup elettronico di FOOT consente di determinare il numero di massa $A$ in modi differenti. In particolare, le misure di TOF, di $p$ e di $E_k$ si possono combinare in tre modi differenti in modo da ottenere tre stime di $A$: $A_1$, $A_2$ e $A_3$. Tali stime si ottengono:
	\begin{itemize}
	...
	\begin{itemize}
		...
		\item Augmented Lagrangian Method (ALM).
	\end{itemize}
