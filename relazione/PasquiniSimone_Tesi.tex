...
\begin{document}
	...
	\end{figure}
	L'ES è composto da tre sezioni, la cui struttura è schematizzata in \hyperref[fig:structure_es]{Fig. 2.7}:
	\begin{itemize}
